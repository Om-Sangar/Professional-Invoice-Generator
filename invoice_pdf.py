...
def get_assessment_financial_year(invoice_date):
    ...
    # Assessment Year card shows the currently running year (same as
    # the Financial Year) rather than the FY+1 tax-filing convention.
...
def draw_payment_section(c, invoice_data, qr_file, grand_total, y):
    ...
    text(c, right_x, y + 4, "Secure UPI Payment", size=7.5, color=GREY)
